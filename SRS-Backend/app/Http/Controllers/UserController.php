...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $data = $request->validate([
            ...
            'role'            => 'required|in:admin,depot_manager,manager,staff,ccp,hr,procurement,ehs,store_staff',
            'department'      => [
                'required',
    ...
    public function update(Request $request, User $user)
    {
        ...
        $data = $request->validate([
            ...
            'role'            => 'sometimes|in:admin,depot_manager,manager,staff,ccp,hr,procurement,ehs,store_staff',
            'department'      => [
                'sometimes',
                Rule::exists('lookups', 'key')->where(
                    fn ($query) => $query->where('type', 'department')->where('is_active', true)
