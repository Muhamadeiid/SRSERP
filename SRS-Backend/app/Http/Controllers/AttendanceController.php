...
class AttendanceController extends Controller
{
    ...
    public function manual(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'status' => 'nullable|in:present,absent,late,wfh,intervention,incomplete,shortage,off',
    ...
    public function bulkManual(Request $request)
    {
        $data = $request->validate([
            ...
            'rows.*.status' => 'required|in:present,absent,late,wfh,intervention,incomplete,shortage,off',
